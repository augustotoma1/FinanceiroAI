...
async def create_signature(signature_data: SignatureCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        new_signature = Signature(**signature_data.model_dump())
...
async def list_signatures(
    ...
    try:
        ...
        logger.info(f"Retrieved {len(signatures)} signatures (skip={skip}, limit={limit}, search={search}, contract_id={contract_id}, status={status_filter})")
